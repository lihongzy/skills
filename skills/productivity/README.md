...
- **[logicize-statement](./logicize-statement/SKILL.md)**: Turn any Chinese content supplied after the command directly into clear, logical wording, while preserving every piece of source information.
