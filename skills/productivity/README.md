...
- **[logicize-statement](./logicize-statement/SKILL.md)**: Turn any content supplied after the command, in any language, directly into clear, logical wording, while preserving every piece of source information.
