...
- **`/logicize-statement`** is the standalone writing utility for turning Chinese spoken language, scattered requirements, or questions into clear wording while preserving the original meaning.
